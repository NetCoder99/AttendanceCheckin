...
// ---------------------------------------------------------------------------
// respond to the rank_updated completed event
// ---------------------------------------------------------------------------
document.body.addEventListener("ranks_response_completed", function(event) {
    console.log(`ranks_response_completed was received`);
    document.getElementById('btn_rank_modal_close').click();
    const badgeMessage     = document.getElementById('badgeMessage');
    badgeMessage.innerHTML = "Student rank was updated";
    badgeMessage.classList.add("text-success");
    setTimeout(function() {
        badgeMessage.innerHTML = "";
        badgeMessage.classList.remove ("text-danger");
