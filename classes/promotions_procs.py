...
from models.models import Students, Requirements, Attendance, Belts, Promotions, NextPromotion
...
def GetLastBeltPromotionDate(student_record: Students):
    ...
    elif student_record.studentPromotionDate :
        return parse(student_record.studentPromotionDate, fuzzy=False)
    else:
        return parse(student_record.memberSince, fuzzy=False)
