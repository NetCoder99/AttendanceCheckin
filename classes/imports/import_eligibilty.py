...
# from models.models import EligibilityCounts
# from datetime import datetime
#
# def importEligibility(srce_db_name: str, dest_db_name: str):
#     excep_list    = []
...
#         for import_record in db_session_srce.query(EligibilityCounts):
